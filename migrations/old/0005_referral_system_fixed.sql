-- Migration: Add referral system tables and columns (Fixed)
-- Date: 2025-12-04

-- Add new referral columns to users table (only if they don't exist)
...
-- Copy data from referred_by_code to referred_by
UPDATE users SET referred_by = referred_by_code WHERE referred_by_code IS NOT NULL;
